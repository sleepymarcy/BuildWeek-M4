    ...
    return(
        ...
        <div id="profile-left" className="card mb-3">
            ...
            <div className="card-body text-center pt-1">
                <h6 className="card-title font-weight-bold dark mt-4"><a href="#" className="dark">vijay kumar vemana</a></h6>
                <p className="card-text text-muted"><small>strive school</small></p>
            </div>
          ...
          <h6><small>Grow Your Network</small></h6>
          <div className="list-group-item text-center  d-flex justify-content-between  ">
              
              <p className="mb-0"><small className="text-muted ">Connections</small></p>
              <small className="viewscount text-muted">7</small>
          </div>
      </div>
      <div className="list-group list-group-flush">
      <div className="list-group-item    bg-light">
                      <p className="mb-0"><small className="text-muted ">Access exclusive tools &amp; insights</small></p>
                      <small className="align-middle">
                      <a href="#" className="font-weight-bold text-dark"><TiLockClosed/>Free Upgrade to Premium</a>
                      </small>
                  </div>
      ...
      <div className="list-group-item    bg-light">
      <small className="align-middle">
                      <a href="#" className="font-weight-bold text-dark"><IoIosBookmark />My Items</a>
                      </small>
                  </div>
